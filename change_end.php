...
<html lang="en">
    ...
    <body>
        ...
        <img src="images/change_icon.png" alt="My Image" style="width: 80px; height: 80px; object-fit: cover;">
                            <h2 class="text-center mb-4">변경이<br>완료되었습니다.</h2>
                            <div class="text-center">
                                <h4>다시 메인 페이지로<br>이동해볼까요?<br><br><br><br><br><br><br><br></h4>
                            </div>
                            <div style="text-align: center;">
                            <button type="button" class="btn btn--blue" onClick="location.href='main.php'">이동</button>
                            </div>
        </div>
