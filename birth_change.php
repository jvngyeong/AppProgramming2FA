...
<html lang="en">
    ...
    <body>
        ...
        <div class="col-md-6 col-lg-5">
					...
					<h2 class="text-center mb-4">변경하실 생년월일을<br>입력하세요.<br><br><br><br><br><br></h2>
                    <form action="birth_change_process.php" class="login-form" method="post">
						<div class="form-group">
                        <input style="margin: auto;" type="date" id="birth" name="birth" class="Input" placeholder="Birth" required>
                        </div>
                        <br>
					<div class="form-group">
