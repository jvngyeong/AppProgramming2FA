...
<html lang="en">
    ...
    <body>
        ...
        <div class="col-md-6 col-lg-5">
					...
					<h2 class="text-center mb-4">변경하실 패스워드를<br>입력하세요.<br><br><br><br><br><br></h2>
						<form action="pass_change_process.php" class="login-form" method="post">
						<div class="form-group">
                            <input style="margin: auto;" type="password" id="user_pw" name="user_pw" class="Input" placeholder="Password" required>
                        </div>
                        <br>
					<div class="form-group">
