...
<html lang="en">
    ...
    <body>
        ...
        <div class="col-md-6 col-lg-5">
					...
					<h2 class="text-center mb-4">변경하실 이름을<br>입력하세요.<br><br><br><br><br><br></h2>
						<form action="name_change_process.php" class="login-form" method="post">
						<div class="form-group">
                        <input style="margin: auto;" type="text" name="name" id="name" class="Input" placeholder="Name" required>
                        </div>
                        <br>
					<div class="form-group">
