...
<html lang="en">
    ...
    <body>
        ...
        <div id="test" class="slide-in2" style="padding-top:100px;">
            <div class="margin1">
                <div class="section">
                    <h2 class='toongotxt'>월요웹툰</h2>
                    <button class="btn btn--blue" id="toongobtn" onclick="location.href='montoons.php'">바로 가기</button>
                </div>
                <div class="section">
                    <h2 class='toongotxt'>화요웹툰</h2>
                    <button class="btn btn--blue" id="toongobtn" onclick="location.href='tuetoons.php'">바로 가기</button>
                </div>
                <div class="section">
                    <h2 class='toongotxt'>수요웹툰</h2>
                    <button class="btn btn--blue" id="toongobtn" onclick="location.href='wedtoons.php'">바로 가기</button>
                </div>
                <div class="section">
                    <h2 class='toongotxt'>목요웹툰</h2>
                    <button class="btn btn--blue" id="toongobtn" onclick="location.href='thutoons.php'">바로 가기</button>
                </div>
                <div class="section">
                    <h2 class='toongotxt'>금요웹툰</h2>
                    <button class="btn btn--blue" id="toongobtn" onclick="location.href='fritoons.php'">바로 가기</button>
                </div>
                <div class="section">
                    <h2 class='toongotxt'>토요웹툰</h2>
                    <button class="btn btn--blue" id="toongobtn" onclick="location.href='sattoons.php'">바로 가기</button>
                </div>
                <div class="section">
                    <h2 class='toongotxt'>일요웹툰</h2>
                    <button class="btn btn--blue" id="toongobtn" onclick="location.href='suntoons.php'">바로 가기</button>
                </div>
